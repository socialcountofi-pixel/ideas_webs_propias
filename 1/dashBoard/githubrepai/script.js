 ...
 */
import { fetchPokemonSpecies, loadMenuspe, loadPokemonSpecies } from './apisfiltros/pokemon_species_copy.js';
/**
 * Obtiene formas
 */
...
import { fetchPokemonForm, loadMenuspf, loadPokemonForm } from './apisfiltros/pokemon_form_copy.js';
...
//import { fetchPokemonFormSp ,loadMenuspSp} from './apisfiltros/pokemon_species.js';
 
async function specie(pokemon){

//console.log('specie pokemon',pokemon,'fin');

//0: {name: 'flabebe-red', url: 'https://pokeapi.co/api/v2/pokemon-form/669/'}

//console.log('especiesespecie',pokemon);

//fetchPokemonForms(pokemon.forms);
//loadMenuspSp(pokemon.species);//datos de las especies del pokemon
